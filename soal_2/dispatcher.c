...
//             printf("Pesanan Reguler untuk %s telah dikirim oleh %s.\n", target_nama, user_agent);
//             return;
//         }
//     }
...
//                 printf("Status pesanan %s: Delivered oleh %s\n", orders[i].nama, orders[i].agen);
//             } else {
//                 printf("Status pesanan %s: Pending\n", orders[i].nama);
//             }
//             return;
//         }
//     }
...
//     printf("------------------------------------------\n");
//     for (int i = 0; i < MAX_ORDERS; i++) {
//         if (strlen(orders[i].nama) == 0) break;  // <-- Perubahan di sini
...
//         if (!user_agent) user_agent = "AGENT USER";
